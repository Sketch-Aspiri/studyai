    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted mt-1">
          Bienvenido a StudyAI. Crea tu primer proyecto para empezar.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { label: "Proyectos", value: "0", icon: "📁" },
          { label: "Documentos", value: "0", icon: "📄" },
          { label: "Recursos generados", value: "0", icon: "✨" },
      ...
      <div className="bg-white rounded-[--radius-md] border border-border p-8 flex flex-col items-center justify-center text-center max-w-md mx-auto">
        ...
        <a
          href="/projects"
          className="inline-flex items-center gap-2 rounded-[--radius-sm] bg-primary px-4 py-2.5 text-sm font-medium text-white hover:bg-primary-hover transition-colors"
        >
