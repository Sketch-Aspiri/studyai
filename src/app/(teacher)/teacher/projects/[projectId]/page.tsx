  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      <section className="bg-white rounded-[--radius-md] border border-border p-6">
        <h2 className="text-base font-semibold text-foreground mb-4">Recursos y exámenes</h2>
        {project.documents.length === 0 ? (
          <p className="text-sm text-muted">
            Sube al menos un documento para poder generar exámenes con IA.
          </p>
        ) : (
          <p className="text-sm text-muted">
            La generación de exámenes con IA estará disponible próximamente.
          </p>
        )}
      </section>
    </div>
